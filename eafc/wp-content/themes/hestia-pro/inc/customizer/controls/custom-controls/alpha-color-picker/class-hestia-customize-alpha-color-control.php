...
class Hestia_Customize_Alpha_Color_Control extends WP_Customize_Control {
	...
	public function render_content() {
		...
		if ( 'color_upsell_notice' === $this->id ) {
			echo '<a href="' . ( tsdk_utmify( 'https://themeisle.com/themes/hestia-pro/upgrade/', 'colornotices' ) ) . '" class="button-primary button" target="_blank">' . esc_html__( 'Upgrade to Unlock', 'hestia-pro' ) . '</a>';
			return;
		}
		?>
		<label>
